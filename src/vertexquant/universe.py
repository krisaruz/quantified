...
from vertexquant.models.bond import BondBasic, BondDaily
...
def build_filtered_ranked(
    ...
    """
    from vertexquant.filter import FilterChain
    ...
    if not filtered.empty and "cb_close" in filtered.columns and "premium_rate" in filtered.columns:
        from vertexquant.scoring import compute_composite_score, assign_risk_level
