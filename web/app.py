...
from vertexquant.portfolio import Holding, append_trade_history, load_portfolio, load_trade_history, save_portfolio
from vertexquant.recommender import Recommender
from vertexquant.universe import build_filtered_ranked, build_universe
...
def api_stats():
    """系统总览统计"""
    from vertexquant.db import get_meta
    from vertexquant.models.bond import BondBasic
...
def _get_version() -> str:
    from vertexquant import __version__
    return __version__
